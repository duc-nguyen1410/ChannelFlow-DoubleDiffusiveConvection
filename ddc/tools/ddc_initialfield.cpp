...
int main(int argc, char* argv[]) {
    cfMPI_Init(&argc, &argv);
    {
        ...
        const string modelabel = args.getstr("-mode", "--modelabel", "nor", "problem/mode of initial conditions");
        const Real lenwavex = args.getreal("-lwx", "--lengthwavenumberx", 1.0, "length of wavenumber in x-direction");
        const Real lenwavey = args.getreal("-lwy", "--lengthwavenumbery", 1.0, "length of wavenumber in y-direction");
        ...
        if(modelabel=="yang2021jfm_case3"){// define initial contions of Yang2021JFM's simulation
            ...
            addRandomPerturbations(u,1e-3);
            #ifdef P5
            addSinusoidalPerturbations(temp,magn,lenwavey);
            #endif
            #ifdef P6
            addSinusoidalPerturbations(salt,magn,lenwavey);
            #endif
        } else{// random mode
            addRandomPerturbations(u,1e-3);
            #ifdef P5
